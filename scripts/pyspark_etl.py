...
# Read the data from the Glue Catalog with the predicate pushdown
datasource0 = glueContext.create_dynamic_frame.from_catalog(
    database="youtube-cleaned-data-db", 
...
# Convert the cleaned DataFrame back to DynamicFrame
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "df_final_output")

# Write to S3 as partitioned Parquet files with partitioning by 'region'
datasink4 = glueContext.write_dynamic_frame.from_options(
    frame=df_final_output, 
    connection_type="s3", 
    connection_options={
        "path": "s3://aws_bucket_name/youtube/raw_statistics",
